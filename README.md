...
<details><Summary>Problemas conhecidos</summary>
 ...
 A partir daí, caso apareça o Alert dizendo  *Não foi possÍvel finalizar a operação, pois a página que se está tentando acessar não está mais ativa. Por favor, reinicie os procedimentos.* , pressione para voltar à página anterior e funcionará como esperado.
</details>
